...
function PolicyGenerator2({navigation}) {
  const labels = ["", "", "", "", ""];
      ...
      <StepIndicator
        ...
        <View style={styles.agree}>
          ...
          <View style={styles.section2}>
            ...
            <View className="flex-row bg-gray-200 h-15 rounded-lg pr-1">
              <TextInput
                style={styles.input}
                type="date"
        ...
        <View style={styles.center}>
          <TouchableOpacity style={styles.nextButton} onPress={()=>navigation.navigate('PolicyGenerator3')}>
