...
function PolicyGenerator3({navigation}) {
  const labels = ["", "", "", "", ""];
    ...
    <View style={styles.wrapper} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.agree}>
        ...
        <Text style={styles.normaltext}>
          Clause 2: Credit <Text style={styles.TextStyle}>________________</Text>
        </Text>
        <Text style={styles.normaltext}>
      ...
      <View style={styles.center}>
        <TouchableOpacity style={styles.nextButton} onPress={()=>navigation.navigate('PolicyGenerator4')}>
