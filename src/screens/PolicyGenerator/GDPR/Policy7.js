    ...
    <ScrollView style={styles.wrapper} showsVerticalScrollIndicator={false}>
      ...
      <View style={{paddingHorizontal: 11, paddingTop: 16}}>
            ...
            <View style={{flex:1 ,display:"flex",flexDirection:"column",marginVertical:20,marginHorizontal:30,justifyContent:'space-between'}}>
              <TouchableHighlight {...touchProps1}>
                <View style={{display:"flex",flexDirection:"row",justifyContent:"space-between",padding:10}}>
                  <Text style={{width:"90%",color:"#585858"}}>Contact form</Text>
              ...
              <TouchableHighlight {...touchProps2}>
                <View style={{display:"flex",flexDirection:"row",justifyContent:"space-between",padding:10}}>
                  <Text style={{width:"90%",color:"#585858"}}>Email address</Text>
              ...
              <TouchableHighlight {...touchProps3}>
                <View style={{display:"flex",flexDirection:"row",justifyContent:"space-between",padding:10}}>
                  <Text style={{width:"90%",color:"#585858"}}>Business address</Text>
                  <TouchableOpacity style={list[16] ? {} : {display:"none"}} onPress={()=>list[17](false)}><Text style ={{color:"#585858"}}> x  </Text></TouchableOpacity>
                </View>
              </TouchableHighlight>
            </View> 
            <Text style={styles.text_2}>What is your DPO’s email address?</Text>
            <TextInput
              style={styles.input_vm}
              value={list[18]}
              onChangeText={(value)=>{
          ...
          <RadioGroup
              ...
              containerStyle={styles.radio_hm}
          />
          <Text style={styles.text_2}>What kind of responsive action will you take if you have a data breach?</Text>
          <View style={{flex:1 ,display:"flex",flexDirection:"column",marginVertical:20,marginHorizontal:30,justifyContent:'space-between'}}>
              <TouchableHighlight {...touchProps4}>
                <View style={{display:"flex",flexDirection:"row",justifyContent:"space-between",padding:10}}>
                  <Text style={{width:"90%",color:"#585858"}}>Post notifications in the mobile app.</Text>
              ...
              <TouchableHighlight {...touchProps5}>
                <View style={{display:"flex",flexDirection:"row",justifyContent:"space-between",padding:10}}>
                  <Text style={{width:"90%",color:"#585858"}}>Notify users via email.</Text>
              ...
              <TouchableHighlight {...touchProps6}>
                <View style={{display:"flex",flexDirection:"row",justifyContent:"space-between",padding:10}}>
                  <Text style={{width:"90%",color:"#585858"}}>Notify users via phone call.</Text>
              ...
              <TouchableHighlight {...touchProps7}>
                <View style={{display:"flex",flexDirection:"row",justifyContent:"space-between",padding:10}}>
                  <Text style={{width:"90%",color:"#585858"}}>Send users a letter.</Text>
                  <TouchableOpacity style={list[28] ? {} : {display:"none"}} onPress={()=>list[29](false)}><Text style ={{color:"#585858"}}> x  </Text></TouchableOpacity>
                </View>
              </TouchableHighlight>
          </View>
          <Text style={styles.text_2}>How can users contact you regarding this policy?</Text>
          <View style={{flex:1 ,display:"flex",flexDirection:"column",marginVertical:20,marginHorizontal:30,justifyContent:'space-between'}}>
              <TouchableHighlight {...touchProps8}>
                <View style={{display:"flex",flexDirection:"row",justifyContent:"space-between",padding:10}}>
                  <Text style={{width:"90%",color:"#585858"}}>Contact form</Text>
                  <TouchableOpacity style={list[30] ? {} : {display:"none"}} onPress={()=>{list[31](false);list[37]("")}}><Text style ={{color:"#585858"}}> x  </Text></TouchableOpacity>
                </View>
              </TouchableHighlight>
              <TouchableHighlight {...touchProps9}>
                <View style={{display:"flex",flexDirection:"row",justifyContent:"space-between",padding:10}}>
                  <Text style={{width:"90%",color:"#585858"}}>Email address</Text>
                  <TouchableOpacity style={list[32] ? {} : {display:"none"}} onPress={()=>{list[33](false);list[39]("")}}><Text style ={{color:"#585858"}}> x  </Text></TouchableOpacity>
                </View>
              </TouchableHighlight>
              <TouchableHighlight {...touchProps10}>
                <View style={{display:"flex",flexDirection:"row",justifyContent:"space-between",padding:10}}>
                  <Text style={{width:"90%",color:"#585858"}}>Business address</Text>
                  <TouchableOpacity style={list[34] ? {} : {display:"none"}} onPress={()=>{list[35](false);list[41]("")}}><Text style ={{color:"#585858"}}> x  </Text></TouchableOpacity>
                </View>
              </TouchableHighlight>
          </View>
          <View style={list[30] ? {} : {display:"none"}}>
            <Text style={styles.text_2}>What is the URL of your contact form?</Text>
            <TextInput
              style={styles.input}
              value={list[36]}
          ...
          <Text style={styles.text_2}>How will you notify users of the updates to this policy?</Text>
          <View style={{flex:1 ,display:"flex",flexDirection:"column",marginVertical:20,marginHorizontal:30,justifyContent:'space-between'}}>
              <TouchableHighlight {...touchProps11}>
                <View style={{display:"flex",flexDirection:"row",justifyContent:"space-between",padding:10}}>
                  <Text style={{width:"90%",color:"#585858"}}>Update the modification date at the bottom of the privacy policy page.</Text>
