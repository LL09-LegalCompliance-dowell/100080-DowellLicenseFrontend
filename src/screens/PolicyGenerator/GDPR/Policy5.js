        ...
        <ScrollView style={styles.wrapper} showsVerticalScrollIndicator={false}>
          ...
          <View style={{paddingHorizontal: 11, paddingTop: 16}}>
            <Text style={styles.text_2}>
              Do you anonymize user’s personal information before making it
              available to analytics or tracking tools?
            </Text>
            <RadioGroup
              radioButtons={list[0]}
            ...
            />
            <Text style={styles.text_2}>
              Do you have affiliate links in your mobile app?
            </Text>
            <RadioGroup
              radioButtons={list[2]}
            ...
            />
            <Text style={styles.text_2}>
              Do you display ads in your mobile app (such as Google AdSense,
              AdMob, BuySellAds, etc)?
            </Text>
            <RadioGroup
              radioButtons={list[4]}
            ...
            />
            <Text style={styles.text_2}>
              Do you collect user data for remarketing (via Google, Facebook,
              etc)?
            </Text>
            <RadioGroup
              radioButtons={list[6]}
            ...
            />
            <Text style={styles.text_2}>
              Do you send email newsletters to your users?
            </Text>
            <RadioGroup
              radioButtons={list[8]}
            ...
            />
            <Text style={styles.text_2}>
              Do you send push notifications to your users?
            </Text>
            <RadioGroup
            ...
            />
            <Text style={styles.text_2}>
              Do you use a third-party provider to send push notifications?
            </Text>
            <RadioGroup
            ...
            <View
              ...
              <TouchableHighlight {...touchProps4}>
                <View
                  ...
                  <Text style={{width: '90%', color: '#585858'}}>
                    Sensitive personal information (ethnicity, religious
              ...
              <TouchableHighlight {...touchProps5}>
                <View
                  ...
                  <Text style={{width: '90%', color: '#585858'}}>
                    Biometric information (facial recognition, fingerprints,
                    etc)
                  </Text>
                  <TouchableOpacity
            ...
            <Text style={styles.text_2}>
              Will you be requesting access to the geolocation of your users?
            </Text>
            <RadioGroup
            ...
            />
            <Text style={styles.text_2}>
              Will you be requesting access to various features on the mobile
              device (such as contacts, calendar, gallery, etc)?
            </Text>
            <RadioGroup
            ...
            />
            <Text style={styles.text_2}>
              Do you collect any derivative data from your users (ip address,
              browser name, device name, etc)?
            </Text>
            <RadioGroup
