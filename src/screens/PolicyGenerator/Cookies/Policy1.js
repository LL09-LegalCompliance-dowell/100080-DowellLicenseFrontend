    ...
    <>
      <KeyboardAwareScrollView style={{flex: 1}}>
        <ScrollView style={styles.wrapper} showsVerticalScrollIndicator={false}>
          ...
          <Text
            style={{color: colors.textDark, fontSize: 20, fontWeight: '400'}}>
            Policy details:
          </Text>
          <View style={{paddingHorizontal: 11, paddingTop: 16}}>
            <Text style={styles.text_2}>
              Full Name of the entity that owns and runs the website:
            </Text>
            <TextInput
            ...
            />
            <Text style={styles.text_2}>
              Will the cookies store personal information that have been
              provided by users via the website
            </Text>
            <View>
              <RadioGroup
                radioButtons={list[4]}
            ...
            <View style={flag ? {} : styles.hide}>
              <View
                ...
                {list[7].map((item, index) => {
                  return (
                    <View key={index} style={styles.Pressed_flex}>
            ...
            <Text
              style={
                flag
                  ...
                  : {color: colors.textDark, fontSize: 18, fontWeight: '400'}
              }>
              Details about information the third party cookies will be
              collecting from users of the website.
            </Text>
            <TextInput
              style={styles.input_vm}
              value={list[9]}
            ...
            />
            <Text style={styles.text_2}>
              Does your website/app use Essential Cookies? (eg. These cookies
            ...
            <Text style={styles.text_2}>
              Does your website/app use any Performance and Functionality
              Cookies? (eg. Performance and Functionality Cookies help you
              remember that an user had logged in previously.)
            </Text>
            <View>
              <RadioGroup
            ...
            <Text style={styles.text_2}>
              Does your website/app use Marketing cookies? (eg. Marketing
              Cookies enable you to identify future prospects and personalize
            ...
            <Text style={styles.text_2}>
              Does your website/app use Analytics and Customization Cookies?
              (eg. These cookies collect information that is used to help you
              understand how your platform is being used or how effective your
            ...
            <Text style={styles.text_2}>
              Does your website/app use Social Media Cookies? (eg. These cookies
              are used when users log in with Facebook, Twitter or Google.)
            </Text>
            <View>
              <RadioGroup
            ...
            <Text style={styles.text_2}>
              Does your website/app use Third Party Cookies? (eg. Third party
              service providers control many of the performance and
