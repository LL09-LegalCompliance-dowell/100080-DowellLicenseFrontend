      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        <View style={styles.viewSampleContainer}>
          <TouchableOpacity
            ...
            onPress={() => {
              navigation.navigate('policy_image');
            }}>
              ...
              data: [
                {
                  ...
                  answer:
                    'Cookies are small pieces of text sent to your browser by the websites you visit. It helps the website to remember a few information of users when they visit the website again. It allows the site to display the selected setting and targeted contents for the users.',
                },
                {
                  question: 'Why do you need consent to use cookies?',
                  answer:
                    'Cookies can process personal information and identifiable information of visitors on the website or users of the website.To protect the privacy policies of such users and visitors, the option to refuse the cookies policies is also available. As per the GDPR and ePrivacy Directive guidelines a website must ask for cookies consent from users. The cookies collect personal data of users and it is unlawful to collect personal data of users without their consent.',
                },
              ],
            });
          }}>
