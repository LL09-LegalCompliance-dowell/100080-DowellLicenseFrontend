...
const Steps = () => {
  ...
  const handle_selected = state => {
    ...
    if (!flag) setSelected([...selected, state]);
  };
  const handle_selected_v2 = state => {
    setSelected(selected.filter(item => item !== state));
  };
  ...
  const handle_selected1 = state => {
    ...
    if (!flag) setSelected1([...selected1, state]);
  };
  const handle_selected1_v2 = state => {
    setSelected1(selected1.filter(item => item !== state));
  };
  ...
  const states = [
    ...
    radioButtons4,
    handle_radiobuttons4,
    radioButtons5,
    handle_radiobuttons5,
    radioButtons6,
    handle_radiobuttons6,
    selected1,
    handle_selected1,
    handle_selected1_v2,
    empty_validationn,
  ...
  const states_1 = [
    radioButtons1_1,
    handle_radiobuttons1_1,
    radioButtons2_1,
    handle_radiobuttons2_1,
    isPress1,
    handle_isPress1,
    isPress2,
    handle_isPress2,
  ...
  const request_object = {
    ...
    website_uses_other_technologies_to_perform_other_functions_achieved_via_cookie:
      q,
