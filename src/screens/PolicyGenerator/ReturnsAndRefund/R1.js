...
const R1 = ({navigation}) => {
  const goToReturnsAndRefund = async() => {
    try {
      await checkCredits()
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            navigation.navigate('FAQ', {
              header: 'Return and Refund',
              data: [
                {
                  question: 'What is Return and Refund Policy?',
                  answer:
                    'Return and Refund Policy dictates under what conditions customers are eligible to return the products they have bought previously and reimbursement for those returned goods. Generally these Return and Refund Policy comes with the time frame under which companies can accept the returns and offer refunds.',
                },
                {
                  question: 'Why is the Return and Refund Policy important?',
                  answer:
                    'A Return and Refund Policy is important for all small and large businesses if they sell their products online. It protects the business from bad customers and in return it also helps the customers to know what to expect when they order a product. For any e-commerce business to prosper it is suggested to have a clear Return and Refund Policy.',
                },
              ],
            });
          }}>
