        ...
        <ScrollView style={styles.wrapper} showsVerticalScrollIndicator={false}>
          ...
          <View style={{paddingHorizontal: 11, paddingTop: 16}}>
            ...
            <Text style={styles.text_2}>
              Cancellation rights of Order within days(in number):
            </Text>
            <TextInput
              style={styles.input_vm}
              value={list[8]}
            ...
            <View
              style={
                valid_url
                  ? {position: 'absolute', top: 490, left: 170}
                  : {position: 'absolute', top: 515, left: 170}
              }>
              <RadioGroup
            ...
            <Text style={styles.text_2}>
              Reimbursement of cancellation Money:
            </Text>
