      ...
      <KeyboardAwareScrollView style={{flex: 1}}>
        <ScrollView style={styles.wrapper} showsVerticalScrollIndicator={false}>
          ...
          <View style={{paddingHorizontal: 11, paddingTop: 16}}>
            ...
            <Text style={styles.text_2}>
              Will it state how often maintenance will occur and on what
              schedule?
            </Text>
            <View>
              <RadioGroup
            ...
            <Text style={styles.text_2}>
              What will be the start date for the users to be bound by the terms
              and conditions?
            </Text>
            <View>
              <RadioGroup
            ...
            <Text style={styles.text_2}>
              Will the user be able to install the software on more than one
              device?
            </Text>
            <View>
              <RadioGroup
            ...
            <Text style={styles.text_2}>
              What violations give the software provider the rights to cancel
              the agreement?
            </Text>
            <TextInput
