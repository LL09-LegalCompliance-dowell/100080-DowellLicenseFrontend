...
const Steps = () => {
  ...
  const [witness, setWitness] = useState([
    {id: 0, name: '', address_1: '', address_2: '', address_3: ''},
  ]);
  ...
  const request_object = {
    ...
    what_will_be_the_date_for_termination_of_this_nda: generate_date(
      date_1.toLocaleDateString(),
    ),
    will_the_party_be_allow_to_enter_into_similar_arragements_with_other_party:
      z,
    the_period_a_party_is_entitle_to_enter_into_similar_arragement_with_other_party:
      parseFloat(n),
    the_period_a_party_is_entitle_to_enter_into_similar_arragement_with_other_party_unit:
      l,
        ...
        <ProgressSteps
          ...
          <ProgressStep
            ...
            onNext={() => {
              ...
              if (
                radioButtons1[0].selected === true &&
                number_validation(input_1_2) == false
              ) {
                x = false;
              }
