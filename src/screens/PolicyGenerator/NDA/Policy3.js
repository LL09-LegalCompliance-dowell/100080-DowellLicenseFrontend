        ...
        <ScrollView style={styles.wrapper} showsVerticalScrollIndicator={false}>
          ...
          <View style={{paddingHorizontal: 11, paddingTop: 16}}>
            <Text style={styles.text_2}>
              Will the obligations of confidentiality subsist after the
            ...
            <Text style={styles.text_2}>
              Will the party be allowed to enter into similar arrangements with
              other parties while the non disclosure agreement
              subsits?(exclusive or not).
            </Text>
            <RadioGroup
              containerStyle={styles.radio_hm}
              radioButtons={list[4]}
            ...
            <View style={list[15] ? '' : styles.hide}>
              <Text style={styles.text_2}>
                If Yes then what will be the time period?
              </Text>
              <TextInput
