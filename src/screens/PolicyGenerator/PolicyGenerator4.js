  ...
  return (
    <View style={styles.wrapper} showsVerticalScrollIndicator={false}>
      <View style={styles.agree}>
        ...
        <Text style={styles.normaltext}>Clasuse:Free documents licensing warning</Text>
        <View style={styles.section2}>
          <Text>Optional element. Although you need to retain the credit, you should remove the inline copyright warning from this document before use.</Text>
          <TextInput style={styles.input} placeholder="Eg." />
          <Text>Clause 3: Term</Text>
          <Text>Clause 3.2</Text>
          <Text>Is the term of the contract indefinite, or will it come to an end upon some agreed date, or upon the occurrence of a defined event?</Text>
          <TextInput style={styles.input} placeholder="Eg." />
          ...
          <Text>Upon the occurrence of what event will the contract terminate?</Text>
          <TextInput style={styles.input} placeholder="Eg." />
        
          <Text>Clause 4: Supply of Software</Text>
          <Text>Clause 4.1 </Text>
          <Text>How many copies of the software will the Licensor deliver to the Licensee?</Text>
          <TextInput style={styles.input} placeholder="Eg." />
          ...
          <Text>Specify the purposes by reference to which sub-licensing is permitted.</Text>
          <TextInput style={styles.input} placeholder="Eg." />
          ...
          <TextInput style={styles.input} placeholder="Eg." />
          <Text>When does the period for payment of an invoice begin to run?</Text>
          <TextInput style={styles.input} placeholder="Eg." />
          <Text style={styles.italic}>Clause 8.3  </Text>
          <Text>Using what methods should payments be made?</Text>
          <TextInput style={styles.input} placeholder="Eg." />
          <Text>Clause 8.4  </Text>
          <Text>What contractual interest rate should apply to late payments?</Text>
          <TextInput style={styles.input} placeholder="Eg." />
        </View>
      </View>
