...
const EndUserLincenceAgreement = () => {
  ...
  return (
    <View style={styles.wrapper}>
      <Text
        style={{padding: 10, color: '#000', fontSize: 20, marginVertical: 10}}>
      ...
      <View style={styles.imageWrapper}>
        ...
        <TouchableOpacity
          style={styles.center}
          onPress={() => {
            navigation.navigate('GDPR Privacy Policy', {screen: 'Gdpr1'});
          }}>
...
export default EndUserLincenceAgreement;
