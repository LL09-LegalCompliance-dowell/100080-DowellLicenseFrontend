...
const Steps = () => {
  ...
  const request_object = {
    ...
    when_will_the_freelancer_share_his_status_on_deliverables: generate_date(
      date_2.toLocaleDateString(),
    ),
    when_will_the_progress_meetings_occur: generate_date(
      date1_2.toLocaleDateString(),
    ),
    what_is_the_minimum_time_required_to_complete_this_project:
      parseFloat(input2_2),
    ...
    when_should_the_invoices_be_submitted: generate_date(
      date2_2.toLocaleDateString(),
    ),
    when_will_the_invoices_be_payable_by_after_receipt: generate_date(
      date3_2.toLocaleDateString(),
    ),
  };
  return (
    <>
