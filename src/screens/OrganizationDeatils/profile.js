            ...
            <View style={{height:"50%"}}>
              <ScrollView>
              {
                data_keys.map((item,id)=>(
                    <TouchableOpacity key={id} style={styles.itemContainer} onPress={() => handleItemPress(item)} >
              ...
              {conditionMet && (<Popup modalVisible={modalVisible} setModalVisible={setModalVisible} policy_name={selectedItem} data={data[selectedItem]} setSelectedItem={setSelectedItem}/> )}
              </ScrollView>
            </View>
